    ...
    namespace VkUtils {
        ...
        size_t getBytesPerPixelFromFormat(VkFormat format) {
            switch (format) {
                ...
                // todo: and many more 32-bit formats
                ...
                default:
                    MOE_ASSERT(false, "Unsupported format");
                    return 0;
            }
        }
        ...
        size_t getChannelsFromFormat(VkFormat format) {
            switch (format) {
                ...
                case VK_FORMAT_B8G8R8_UINT:
                case VK_FORMAT_B8G8R8_SINT:
                case VK_FORMAT_R8G8B8_SRGB:// sRGB
                case VK_FORMAT_B8G8R8_SRGB:// sRGB
                ...
                case VK_FORMAT_X8_D24_UNORM_PACK32:
                case VK_FORMAT_R8G8B8A8_SRGB:// sRGB
                case VK_FORMAT_B8G8R8A8_SRGB:// sRGB
                    return 4;
